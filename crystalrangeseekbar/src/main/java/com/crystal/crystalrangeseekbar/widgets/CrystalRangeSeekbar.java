...
import com.crystal.crystalrangeseekbar.BitmapHelper;
...
public class CrystalRangeSeekbar extends View {
    ...
    protected Bitmap getBitmap(Drawable drawable) {
        return BitmapHelper.getBitmap(getContext(), drawable);
    }
    ...
    protected void overrideBarDisplay(final RectF bounce) {

    }

    protected void overrideBarHighLightDisplay(final RectF bounce) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        overrideBarHighLightDisplay(rect);
    ...
    protected void overrideThumbPosition(final RectF rect, Thumb thumb) {
        rect.top = 0f;
    }
    ...
    protected void setupLeftThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        overrideThumbPosition(rectLeftThumb, Thumb.MIN);
        if (leftThumb != null) {
    ...
    protected void setupRightThumb(final Canvas canvas, final Paint paint, final RectF rect) {
        ...
        overrideThumbPosition(rectRightThumb, Thumb.MAX);
        if (rightThumb != null) {
